<?php
/*
  Template Name: Digital Marketing Page Template
*/
get_header();
  ?>
  <?php while(have_posts()): the_post();  ?>
         <div class="banner">
          <div class="digital-marketing-image" style="  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),  url(<?php echo the_post_thumbnail_url(); ?>);">
             <div class="digital-marketing-text">
              <h1 style="font-size:60px; color:#fff;"><?php the_title(); ?></h1>
            </div>
          </div>
        </div>
    <section class="digital-marketing" style="background-color: #fff;">
        ...
        <div class="row mt-4" style="justify-content: center;">
          <div class="col-md-7">
             <?php
               ...
               ?>
        <img src="<?php echo $image[0]; ?>" alt="digital-marketing-1" style="width: 100%; height: 100%;"> 
